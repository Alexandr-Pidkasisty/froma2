...
//            };
        ...
        decimal* clsRecipeItem::CalcWorkingVolumeItem(const size_t PrCount, const size_t period, const decimal volume) const {
...
//            bool check = true;                          // Индикатор успешности операции
//            for(vector<clsManufactItem>::iterator it = Manuf.begin(); it!=Manuf.end(); it++) {  // Цикл по элементам вектора
//                check = check && it->CalculateItem();   // Расчет незавершенного производства и готовой продукции в элементе
//            };
//            return check;
//        }   // Calculate
