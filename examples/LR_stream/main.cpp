...
int main() {
    ...
    los  << '\n'
         ...
         << strE
         << '\n'
         << "(Если вводить в поток lrstream объект типа string, то происходит инициали-\n"
         << "зация числа типа LongReal строкой, далее в поток lrstream вводится число\n"
         << "типа LongReal. В операторе ostream& operator<<(ostream&, const LongReal&)\n"
         << "это число конвертируется в double и далее выодится в поток как double)"
         << '\n'
         ...
         << fEe
         <<'\n'
         << "\nВводим манипулятор для изменения точности вывода чисел типа LongReal.\nНовая точность "
         << m
