...
string cfg_file = "config.cfg";                     // Определение глобальной переменной (имя конфиг-файла)
...
/****************************************************************************************************/
    ...
    if(argc > 1) cfg_file = string(argv[1]);        // Заменяем имя конфиг-файла из аргумента программы
