...
/** Метод создания склада готовой продукции (СГП) и ввода в него данных. **/
...
/** Метод редактирует индивидуальные настройки учета номенклатурных единиц на выбранном складе (СГП или ССМ).
Для каждого SKU возможно изменение данных: флаг авторасчета закупок, флаг разрешения на отгрузку и закупку в
одном периоде и норматив запаса на складе. Настройки сохраняются в объекте "склад" и конфигурационном файле. **/
