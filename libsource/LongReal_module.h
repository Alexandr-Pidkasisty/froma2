...
/** Класс для хранения и совершения арифметических операций с длинными вещественными числами. **/
    ...
    public:
        ...
        operator long double() const;           // Оператор присваивания переменной типа long double
        operator double() const;                // Оператор присваивания переменной типа double
        operator float() const;                 // Оператор присваивания переменной типа float
