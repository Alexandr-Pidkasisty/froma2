...
const size_t divDigits = 64;            // Максимальное количество цифр после запятой
...
/** Оператор арифметического умножения. Возвращает результат умножения двух чисел типа LongReal в виде нового объекта **/
    ...
    res.Resize(divDigits);                          // Обрезаем мантиссу до указанного значения
...
/** Вычисление обратного числа текущему (1/х)/ **/
    ...
    size_t maxNumbers = divDigits + (size_t)intPart;    // Максимальное число цифр массива
